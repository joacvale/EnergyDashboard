...
var offer_unit_store_1 = require("../../stores/offer-unit.store");
var DynamicTableComponent = /** @class */ (function () {
    function DynamicTableComponent() {
        this.offerUnit = core_1.input.required();
        this.offerUnitStore = core_1.inject(offer_unit_store_1.OfferUnitStore);
        this.tableData = [
            {
                rowName: 'Volume',
                field: 'volume'
    ...
    DynamicTableComponent = __decorate([
        core_1.Component({
            ...
            imports: [forms_1.FormsModule, input_directive_1.InputDirective],
            standalone: true,
