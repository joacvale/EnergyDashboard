...
var ProductionComponent = /** @class */ (function () {
    function ProductionComponent() {
        ...
        this.filter = "";
        this.panelsDataSource = new table_2.MatTableDataSource();
        ...
        core_1.effect(function () {
            _this.panelsDataSource.data = _this.solarPanelService.panels();
        });
    }
    Object.defineProperty(ProductionComponent.prototype, "matPaginator", {
    ...
    ], ProductionComponent.prototype, "matPaginator");
